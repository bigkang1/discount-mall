...
func (r *ManageAdminUserRouter) InitManageAdminUserRouter(Router *gin.RouterGroup) {
	...
	var mallAdminUserApi = v1.ApiGroupApp.ManageApiGroup.ManageAdminUserApi
	{
		...
		mallAdminUserRouter.PUT("users/addCurrency", mallAdminUserApi.AddUserCurrency)
		mallAdminUserRouter.PUT("users/deleteCurrency", mallAdminUserApi.DeleteUserCurrency)
		mallAdminUserRouter.PUT("resetUserPassword", mallAdminUserApi.ResetUserPassword)
		mallAdminUserRouter.PUT("resetUserPayPassword", mallAdminUserApi.ResetUserPayPassword)
		mallAdminUserRouter.PUT("users/updateUserBankCard", mallAdminUserApi.UpdateUserBankCard)
	}
	{
