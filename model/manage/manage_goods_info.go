...
type MallGoodsInfo struct {
	...
	OriginalPrice      float64         `json:"originalPrice" form:"originalPrice" gorm:"column:original_price;comment:商品价格;type:float"`
	SellingPrice       float64         `json:"sellingPrice" form:"sellingPrice" gorm:"column:selling_price;comment:商品实际售价;type:float"`
	IsDiscount         int             `json:"isDiscount" form:"isDiscount" gorm:"column:is_discount;comment:0:没有折扣 1:有折扣;type:tinyint"`
	DiscountEndTime    int             `json:"discount_end_time" form:"discount_end_time" gorm:"column:discount_end_time;comment:折扣截止时间;type:int"`
